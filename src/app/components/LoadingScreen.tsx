...
export default function LoadingScreen({ visible }: { visible: boolean }) {
    ...
    return (
        <div className={"fixed z-50 inset-0 flex justify-center items-center bg-black/50 " + display}>
            <svg className="w-20 animate-spin text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
