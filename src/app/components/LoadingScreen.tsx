export default function LoadingScreen() {
    return (
        <div className="fixed top-0 left-0 right-0 bottom-0 flex justify-center items-center bg-black/30">
            <svg className="w-20 animate-spin" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
